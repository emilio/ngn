...
\fancypagestyle{certificate}{
  \fancyhead[L]{
    \includegraphics[width=0.2\textwidth]{images/usal-logo.pdf}
  }
  \fancyhead[R]{
    \includegraphics[width=0.3\textwidth]{images/fciencias-logo.pdf}
  }
...
\addto\extrasspanish{
  ...
  \def\appendixtocname{Anexos}
  \def\appendixpagename{Anexos}
...
\newcommand*\pandocbounded[1]{% scales image to fit in text height/width
  \sbox\pandoc@box{#1}%
  \Gscale@div\@tempa{\textheight - 1.5em}{\dimexpr\ht\pandoc@box+\dp\pandoc@box\relax}%
...
\begin{center}
  ...
  \includegraphics[width=0.5\textwidth]{images/usal-logo.pdf}
...
\input{build/a1-specs.tex}
\input{build/a2-design.tex}
\input{build/a3-effort.tex}
\input{build/a4-security.tex}
\input{build/a5-other.tex}
